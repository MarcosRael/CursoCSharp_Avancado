...
namespace _01_Generics
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {Nome = "Maria", Email = "maria@gmail.com", Senha = "123456"};
            ...
            Console.WriteLine("Casa: {0} - {1}", casa2.Cidade, casa2.Endereco);
            Console.WriteLine("Usuario: {0} - {1}", usuario2.Nome, usuario2.Email);
